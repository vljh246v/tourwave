...
class OfferExpirationService(
    ...
    fun expireOffers(): OfferExpirationJobResult {
        ...
        val expiredBookingIds = bookingRepository.findExpiredOffers(now)
            .mapNotNull { booking ->
    ...
    private fun promoteWaitlist(occurrenceId: Long, now: java.time.Instant) {
    ...
    private fun appendAudit(before: Booking, after: Booking) {
        auditEventPort.append(
            AuditEventCommand(
                actor = "JOB",
