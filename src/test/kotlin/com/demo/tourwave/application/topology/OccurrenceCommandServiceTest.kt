...
class OccurrenceCommandServiceTest {
    ...
    fun `operator can create update and reschedule occurrence`() {
        ...
        val tour = tourCommandService.create(
            CreateTourCommand(
                actorUserId = requireNotNull(owner.id),
        ...
        val created = occurrenceCommandService.create(
        ...
        val updated = occurrenceCommandService.update(
        ...
        val rescheduled = occurrenceCommandService.reschedule(
    ...
    fun `cannot shrink capacity below occupied seats`() {
        ...
        val occurrence = occurrenceCommandService.create(
            CreateOccurrenceCommand(
                actorUserId = requireNotNull(owner.id),
                tourId = requireNotNull(tour.id),
                capacity = 10,
