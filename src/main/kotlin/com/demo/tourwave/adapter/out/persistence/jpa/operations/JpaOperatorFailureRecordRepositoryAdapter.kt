...
class JpaOperatorFailureRecordRepositoryAdapter(
    ...
    override fun save(record: OperatorFailureRecord): OperatorFailureRecord = operatorFailureRecordJpaRepository.save(record.toEntity()).toDomain()
    ...
    override fun findAll(): List<OperatorFailureRecord> = operatorFailureRecordJpaRepository.findAllByOrderByUpdatedAtUtcDesc().map { it.toDomain() }
