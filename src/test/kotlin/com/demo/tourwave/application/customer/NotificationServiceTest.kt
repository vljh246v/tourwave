...
class NotificationServiceTest {
    ...
    private val paymentRecordRepository =
        object : PaymentRecordRepository {
            ...
            override fun findByStatuses(statuses: Set<com.demo.tourwave.domain.payment.PaymentRecordStatus>) =
                emptyList<com.demo.tourwave.domain.payment.PaymentRecord>()
