...
class ReconciliationService(
    ...
    fun exportDailySummariesCsv(
        ...
        return buildString {
            append(
                "date,bookingCreatedCount,authorizedCount,capturedCount," +
                    "providerCapturedCount,providerRefundedCount,refundPendingCount,refundedCount," +
                    "noRefundCount,refundFailedRetryableCount,refundReviewRequiredCount," +
