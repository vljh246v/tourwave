...
class InstructorRegistrationService(
    ...
    fun apply(command: ApplyInstructorRegistrationCommand): InstructorRegistration {
        ...
        val pathTemplate = "/instructor-registrations"
        ...
        return when (
            ...
            is IdempotencyDecision.Replay -> decision.body as InstructorRegistration
    ...
    fun approve(command: ReviewInstructorRegistrationCommand): InstructorRegistration {
        val pathTemplate = "/instructor-registrations/{registrationId}/approve"
        val requestHash = requestHash("${command.registrationId}")
    ...
    fun reject(command: ReviewInstructorRegistrationCommand): InstructorRegistration {
        val pathTemplate = "/instructor-registrations/{registrationId}/reject"
        val requestHash = requestHash("${command.registrationId}|${command.rejectionReason}")
