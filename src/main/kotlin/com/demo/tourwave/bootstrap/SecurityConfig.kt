    ...
    companion object {
        private val PUBLIC_ENDPOINTS =
            listOf(
                ...
                PublicEndpoint(HttpMethod.GET, "/tours/*/reviews/summary"),
                PublicEndpoint(HttpMethod.GET, "/instructors/*/reviews/summary"),
                PublicEndpoint(HttpMethod.GET, "/organizations/*/reviews/summary"),
