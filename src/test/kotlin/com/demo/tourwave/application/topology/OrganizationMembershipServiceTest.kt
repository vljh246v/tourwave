...
class OrganizationMembershipServiceTest {
    ...
    fun setUp() {
        ...
        val invitee = userRepository.save(User.create(displayName = "Invitee", email = "invitee@test.com", passwordHash = "hash", now = clock.instant()))
    ...
    fun `invite sends delivery and accept consumes token`() {
        ...
        val accepted = service.acceptInvitation(
    ...
    fun `accept rejects token for different actor`() {
        ...
        val ex = assertFailsWith<com.demo.tourwave.domain.common.DomainException> {
