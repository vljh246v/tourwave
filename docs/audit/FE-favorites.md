...
- Features module: ❌
- API client usage: ❌
- SSOT reference: openapi.yaml tag `Favorites`

## BE OpenAPI Paths (3 endpoints)

- `delete /tours/{tourId}/favorite` — Favorite a tour
- `get /me/favorites` — List my inquiries
- `post /tours/{tourId}/favorite` — Tour review summary (public)
