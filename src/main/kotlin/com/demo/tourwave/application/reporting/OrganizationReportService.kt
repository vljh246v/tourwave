...
class OrganizationReportService(
    ...
    fun exportOccurrenceOpsReportCsv(query: OccurrenceOpsReportQuery): String {
        ...
        val header =
            "occurrenceId,organizationId,tourId,startsAtUtc,status,capacity,confirmedSeats,waitlistCount," +
                "seatUtilizationPercent,attendedCount,noShowCount,refundedBookingCount,refundPendingCount"
        val lines =
            page.items.map {
                listOf(
                    it.occurrenceId.toString(),
