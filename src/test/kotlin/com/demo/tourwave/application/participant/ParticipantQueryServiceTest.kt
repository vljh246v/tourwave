...
class ParticipantQueryServiceTest {
    ...
    private val accessPolicy = ParticipantAccessPolicy(
        bookingRepository = bookingRepository,
        bookingParticipantRepository = bookingParticipantRepository
    )

    private val queryService = ParticipantQueryService(
    ...
    fun `booking participant can list participants and expired invitation is refreshed`() {
        ...
        val leader = BookingParticipant.leader(
            bookingId = 91L,
            userId = 101L,
            createdAt = Instant.parse("2026-03-10T00:00:00Z")
        ).copy(id = 1L)
        val expiredInvite = BookingParticipant(
            id = 2L,
            bookingId = 91L,
            userId = 202L,
        ...
        val result = queryService.listBookingParticipants(
